...
describe('Autocomplete tests: ', () => {
  ...
  it('Renders Autocomplete with Error without crashing', () => {
    const component = renderer.create(staticAutocompleteWithError);

    expect(component.toJSON()).toMatchSnapshot();
  });

  it('Renders no suggestions container', (done) => {
  ...
  it('Renders suggestions container', (done) => {
    const component = mount(staticAutocomplete);
  ...
  it('Hides no suggestions on blur', () => {
    const component = mount(staticAutocomplete);
  ...
  it('Fetches suggestions on change', (done) => {
  ...
  it('Fetches Value only when debounce is over', (done) => {
    const component = mount(staticAutocomplete);
  ...
  it('Focusing an Autocomplete calls the onFocus Event', () => {
    const spyFunc = jest.fn();
    const component = mount(<Autocomplete
      data={{items: []}}
      onFocus={spyFunc}
  ...
  it('Bluring an Autocomplete calls the onBlur Event', () => {
    const spyFunc = jest.fn();
    const component = mount(<Autocomplete
      data={{items: []}}
      onBlur={spyFunc}
  ...
  it('Changing an Autocomplete calls the onChange Event', () => {
    const spyFunc = jest.fn();
    const component = mount(<Autocomplete
      data={{items: []}}
      onChange={spyFunc}
