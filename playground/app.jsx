...
const App = ({location: {pathname, query}}) => (
  <div className="app-container container">
    <div className="panel">
      <div className="panel-body" style={{backgroundColor: 'navy'}}>
        <div className="row">
        ...
        <div className="row" style={{backgroundColor: '#0c0c23', textAlign: 'right'}}>
          <DropDown
            ...
            {
              active: false,
              icon: <img alt="test" src="data:image/jpeg;base64," />,
              value: 'Deutschland'
            },
            {
              active: false,
