          ...
          <div
            ...
            <label htmlFor={`star${key}`}>
              <svg
                ...
                <g>
                  <path
                    className={`${styles.path} ${styles[!this.isEmptyStar(key + 1) && 'fill']}`}
                    fill={!this.isEmptyStar(key + 1) && (fillColors[key] || color)}
                    stroke={!this.isEmptyStar(key + 1) && (fillColors[key] || color)}
